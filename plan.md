...
initial default camera model uses these concrete values:

- parent body: `palm`;
- camera/site name: `pointnet_camera_site`;
- position in parent frame: `(-0.14, -0.04, -0.225)`;
- quaternion in parent frame: `(-0.00275173, -0.99081233, 0.0, 0.13521593)`;
